...
from utils.show_masks_no_disp import show_masks
...
def main():
    ...
    image_names = ['sh01.png', 'm1.jpg', 'm2.jpg', 'm3.jpg', 'm4.jpg', 'm5.jpg', 'm6.jpg', 'm7.jpg', 'm8.jpg']
    #image_names = ['e01.jpg', 's01.jpg', 's02.jpg', 's03.jpg', 's04.jpg', 's05.jpg', 's06.jpg', 's07.jpg', 's08.jpg','s09.jpg','s10.jpg']
    image_names = ['i0.png', 'i1.png', 'i2.png', 'i3.png', 'i4.png', 'i5.png', 'i6.png', 'i7.png', 'i8.png','i9.png']
    image_names = ['p1.png', 'p2.png', 'p3.png', 'p4.png', 'p5.png', 'p6.png']
    image_names = ['frame-{:06d}.color.jpg'.format(n) for n in range(1000,2000,100)]
    image_names = ['IMG_20170822_163403.jpg','IMG_20170822_163459.jpg','IMG_20170822_163503.jpg','IMG_20170822_163456.jpg','IMG_20170822_163405.jpg','IMG_20170822_163401.jpg']
    print config.SCALES[0]
    data = []
    im_dir  = cur_path + '/../demo/'
    im_dir  = '/home/micha/images/set1/' 
    #im_dir  = '/home/micha/images/set2/' 
    im_dir  = '/home/micha/images/set3/' 
    im_dir  = '/home/micha/images/set4/' 
    im_dir  = '/home/micha/images/set5/out/' 
    im_dir  = '/home/micha/images/set6/' 
    ...
    for idx, im_name in enumerate(image_names):
        ...
        if not config.TEST.USE_MASK_MERGE:
            ...
            for j in range(1, num_classes):
                indexes = np.where(scores[0][:, j] > th)[0]
            ...
            print (boxes)
            print (scores[0])
            print (config.TEST.NMS)
            print (config.TEST.MASK_MERGE_THRESH)
        ...
        for i in xrange(len(dets)):
            keep = np.where(dets[i][:,-1]>th)
            dets[i] = dets[i][keep]
            masks[i] = masks[i][keep]
        im = cv2.imread(im_dir + im_name)
        im = cv2.cvtColor(im, cv2.COLOR_BGR2RGB)
        imret = show_masks(im, dets, masks, classes, config, show=True)
        cv2.imwrite(os.path.join(out_dir, im_name), imret)
